    ...
    <header className="bg-[#3b5d50] text-white">
      <div className="max-w-[1300px]  mx-auto px-2 py-5">
        <div className="flex items-center justify-between h-16">
          ...
          {/* Logo */}
         <Link href={'/'}>
          <img src="/images/campu_logo-removebg-preview.png" className="w-[150px] h-26" alt="Green Nest Logo" />
         </Link>
          ...
          {/* <Link href={'/login'} className="hidden md:flex items-center gap-6">
            ...
            />
            <img src={user?.photoURL} alt="profile" className="w-[40px] h-[40px] rounded-full"   />
            <Link to={'/login'} className="bg-white text-[#3b5d50] px-6 py-2 rounded-lg font-semibold hover:bg-gray-200 transition">
                Login
              </Link>
          </Link> */}
